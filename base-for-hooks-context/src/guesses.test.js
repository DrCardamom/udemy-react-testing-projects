...
describe('test word guesses', () => {
   ...
   describe('empty guessedWords', () => {
      ...
      test('guessedWords shows correct guesses after incorrect guesses', () => {
         const mockEvent = {target: {value: 'train'}}
         inputBox.simulate('change', mockEvent)
         submitButton.simulate('click')
         const guessedWordTableRows = findByTestAttr(wrapper, 'guessed-word')
         expect(guessedWordTableRows.length).toBe(1)
      })
   })
})